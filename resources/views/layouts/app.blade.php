...
<head>
    ...
    <title>iGram - @yield('titulo')</title>
...
<body>
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    <a class="flex items-center gap-2 bg-white border text-gray-600 rounded text-sm uppercase font-bold cursor-pointer" href="{{route('posts.create')}}">
    ...
    <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
        @yield('titulo') - Todos los derechos reservados {{ now()-> year}}
    </footer>
